...
NEVER-REPEAT design (the proven joke_state.json pattern, applied uniformly):
  ...
  Selection = (last_index + 1) % len, REJECTED if already in used_trailing (a full-cycle
...
WORDS = [
    ...
    {"word": "Server", "pos": "noun", "definition": "A computer built to serve data and services to other machines over a network.", "example": "The file server went down and the office stalled."},
